...
this script iterates through each movie dialogue in each rating range then records the emotion evoked from that dialogue.
...
for rating in rating_dict:
    ...
    for dialog_dict in rating_dict[rating]:
        try:
            ...
            emotion = get_emotion(text) # get the analyzed emotion from that interaction
